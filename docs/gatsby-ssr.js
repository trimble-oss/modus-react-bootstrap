...
export const onRenderBody = ({ setHeadComponents }) => {
  setHeadComponents([
    <link key='fontsGoogleApi' rel='dns-prefetch' href='https://fonts.googleapis.com'></link>,
    <link
      rel='preconnect'
      key='fontsGstatic'
    ...
    <script key='polyfill' noModule={true} src='https://polyfill.io/v3/polyfill.min.js' />,
    <script
      key='plausible'
      defer
