...
<CodeBlock style={{ padding: '0px' }} code={NavbarBasic, trimbleLogo, trimbleIcon}>
...
<CodeBlock title='Blue Variant' style={{ padding: '0px' }} code={NavbarBlue, trimbleLogoRev, trimbleIconRev}>
...
<CodeBlock
  ...
  style={{ padding: '0px' }}
  code={NavbarWithoutHamburger, trimbleLogoRev, trimbleIconRev}
>
