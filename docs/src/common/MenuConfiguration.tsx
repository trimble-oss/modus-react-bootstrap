...
const gettingStartedMenu: Menu = {
  ...
  children: [
    ...
    },
    {
      key: 'usage',
      title: 'Usage',
      subtitle: 'Demonstrate how to import and use the Modus React Bootstrap components.',
    },
    {
      key: 'changelog',
      title: 'Changelog',
...
const utilitiesMenu: Menu = {
  ...
  children: [
    ...
    },
    {
      key: 'close-icon',
      title: 'Close Icon',
      subtitle: 'Use a generic close icon for dismissing content like modals and alerts.',
    },
    {
      key: 'display',
      title: 'Display',
    ...
    },
    {
      key: 'interactions',
      title: 'Interactions',
      subtitle: 'Utility classes that change how users interact with contents of a website.',
    },
    {
      key: 'overflow',
      title: 'Overflow',
    ...
    },
    {
      key: 'position',
      title: 'Position',
      subtitle: 'Use these shorthand utilities for quickly configuring the position of an element.',
    },
    {
      key: 'screen-readers',
    ...
    },
    {
      key: 'sizing',
      title: 'Sizing',
      subtitle: 'Easily make an element as wide or as tall with our width and height utilities.',
    },
    {
      key: 'text',
      title: 'Text',
...
const componentsMenu: Menu = {
  key: 'components',
  title: 'Components',
  subtitle: 'Components are the building blocks of the design system designed with users in mind.',
  children: [
    {
      key: 'accordions',
      title: 'Accordions',
    ...
    },
    {
      ...
      styleguideUrl: 'https://modus.trimble.com/components/file-upload-dropzone/',
      subtitle:
    ...
    },
    {
      ...
      subtitle: 'Input boxes gather information from users. Labels sit atop these elements.',
    },
    {
      key: 'lists',
      title: 'Lists',
      styleguideUrl: 'https://modus.trimble.com/components/lists/',
      subtitle: 'A list can be used to display content related to a single subject.',
    },
    {
      key: 'messages',
      title: 'Messages',
    ...
    },
    {
      ...
      subtitle: 'The navbar provides context through globally accessible menu options.',
    },
    {
      key: 'pagination',
      title: 'Pagination',
    ...
    },
    {
      ...
      subtitle: 'Tooltips provide a short description of a page element or control.',
    },
  ],
}

const GetNavigationMenu = function (includeOnly?: string): Menu[] {
  const menusWithNoIndexPage = [foundationsMenu.key, utilitiesMenu.key]
  return [gettingStartedMenu, layoutMenu, foundationsMenu, componentsMenu, utilitiesMenu]
    .filter((parent) => !includeOnly || parent.key === includeOnly)
    .map((parent) => {
      return {
        path: `/${parent.key}/${
          menusWithNoIndexPage.includes(parent.key) && parent.children ? parent.children[0].key : ''
        }`,
